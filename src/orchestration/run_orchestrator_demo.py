...
def demo_state() -> FarmState:
    return FarmState(
        ...
        plots=[
            PlotState(plot_id="P1", area_m2=300, crop_type="maize", crop_stage="vegetative", soil_moisture=0.40),
            PlotState(plot_id="P2", area_m2=260, crop_type="potato", crop_stage="tuber_init", soil_moisture=0.36),
            PlotState(plot_id="P3", area_m2=240, crop_type="sorghum", crop_stage="vegetative", soil_moisture=0.47),
            PlotState(plot_id="P4", area_m2=180, crop_type="groundnut", crop_stage="flowering", soil_moisture=0.43),
        ],
